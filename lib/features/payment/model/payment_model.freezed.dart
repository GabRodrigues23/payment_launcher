...
mixin _$PaymentModel {
 ...
 PaymentType get type; String get referenceId; double get amount; int? get installments; String? get installmentType;
...
@useResult
$Res call({
 PaymentType type, String referenceId, double amount, int? installments, String? installmentType
});
...
as PaymentType,referenceId: null == referenceId ? _self.referenceId : referenceId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PaymentType type,  String referenceId,  double amount,  int? installments,  String? installmentType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PaymentType type,  String referenceId,  double amount,  int? installments,  String? installmentType)  $default,) {final _that = this;
switch (_that) {
case _PaymentModel():
return $default(_that.type,_that.referenceId,_that.amount,_that.installments,_that.installmentType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PaymentType type,  String referenceId,  double amount,  int? installments,  String? installmentType)?  $default,) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
return $default(_that.type,_that.referenceId,_that.amount,_that.installments,_that.installmentType);case _:
  return null;
